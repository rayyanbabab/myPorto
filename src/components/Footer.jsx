...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { 
      href: "https://www.linkedin.com/in/rayyanmf/", 
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
            ...
            <motion.div
                ...
                className={`w-full grid grid-cols-3 divide-x rounded-2xl border overflow-hidden ${
                    isLight 
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input 
                            ...
                            className={`w-full px-4 py-3 rounded-xl outline-none transition-all duration-300 border text-sm ${
                                isLight 
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        maxLength={500}
                        rows={5}
                        className={`w-full px-4 py-3 rounded-xl outline-none transition-all duration-300 resize-none border text-sm ${
                            isLight 
                                ? 'bg-gray-50 border-gray-200 text-black placeholder-gray-400 focus:border-black focus:bg-white focus:ring-2 focus:ring-black/5' 
                                : 'bg-black/20 border-white/10 text-white placeholder-gray-600 focus:border-white/40 focus:bg-black/30 focus:ring-2 focus:ring-white/5'
                        }`}
                ...
                <button 
                    type="submit" 
                    disabled={formData.isSubmitting}
                    className={`group w-full py-4 rounded-xl font-bold text-sm uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-3 ${
                        isLight
